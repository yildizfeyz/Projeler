...
public class View5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        t_view.setText("for(int i = 0; i < ArrayFunc.boyut - 1; i++)\n" +
                "        {\n" +
                "            for(int j = 0; j < ArrayFunc.boyut - i - 1; j++)\n" +
        ...
        ((Button) view.findViewById(R.id.kodV5)).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        sonuc = (TextView) view.findViewById(R.id.sonucV5);
        sure = (TextView) view.findViewById(R.id.sureV5);
        btn = (Button) view.findViewById(R.id.siralaV5);
