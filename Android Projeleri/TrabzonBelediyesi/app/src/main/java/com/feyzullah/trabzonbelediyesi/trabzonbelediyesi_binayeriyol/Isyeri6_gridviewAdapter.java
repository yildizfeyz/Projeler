...
public class Isyeri6_gridviewAdapter extends BaseAdapter {
    LayoutInflater inflater;
    Context context;


    public Isyeri6_gridviewAdapter(Context context) {
    ...
    @Override
    public int getCount() {
        return Isyeri_veriler.Resimler.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Bitmap bmImg = BitmapFactory.decodeFile(Isyeri_veriler.Resimler.get(position));
