 ...
 */
public class Isyeri_kayitlar_listviewAdapter extends BaseAdapter {
    ...
    public Isyeri_kayitlar_listviewAdapter(Context context ) {

        this.context = context;
        ticarikod = Isyeri_verilerListe.ticarikod.get(1);
        renk = 0;
    ...
    @Override
    public int getCount() {
        return Isyeri_verilerListe.ticarikod.size();
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(position != 0)
            if(ticarikod.equals(Isyeri_verilerListe.ticarikod.get(position)))
                ((RelativeLayout)itemView.findViewById(R.id.kayitgor_layout)).setBackgroundColor(itemView.getResources().getColor(color[renk]));
            else {
                renk = 1 -renk;
                ((RelativeLayout) itemView.findViewById(R.id.kayitgor_layout)).setBackgroundColor(itemView.getResources().getColor(color[renk]));
            }
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_id)).setText(Isyeri_verilerListe.id.get(position));
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_geocode)).setText(Isyeri_verilerListe.ticarikod.get(position));
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_mahalleadi)).setText(Isyeri_verilerListe.isletmeturu.get(position));
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_caddesokakadi)).setText(Isyeri_verilerListe.ickapino.get(position));
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_caddesokakkodu)).setText(Isyeri_verilerListe.isletmeadi.get(position));
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_kapino)).setText(Isyeri_verilerListe.mulkiyetdurumu.get(position));
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_siteadi)).setText(Isyeri_verilerListe.adisoyadi.get(position));
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_apartmanadi)).setText(Isyeri_verilerListe.tcno.get(position));
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_halihazirdurum)).setText(Isyeri_verilerListe.vergino.get(position));
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_discephedurumu)).setText(Isyeri_verilerListe.telefon.get(position));
        ((TextView) itemView.findViewById(R.id.Bina_kayitgor_yapidurumu)).setText(Isyeri_verilerListe.webadresi.get(position));
        ...
        if(position != 0)
            ticarikod = Isyeri_verilerListe.ticarikod.get(position);

        if(position == Isyeri_verilerListe.ticarikod.size() - 1) {renk = 0; ticarikod = Isyeri_verilerListe.ticarikod.get(1);}
        return itemView;
    }
