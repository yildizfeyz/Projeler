...
public class Kitaplar extends javax.swing.JFrame {
    ...
    public Kitaplar() {
        ...
        ResultSet sonuc = tasarim.vt.select("kitaplar", "");
        try
        {
        while(sonuc.next())
                
        {
            ...
            model.addRow(new Object[]{sonuc.getString("ID"), sonuc.getString("kitapadi"), sonuc.getString("yazar"), sonuc.getString("nerede")}); 
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Sıra N.", "Kitap Adı", "Yazarı", "Nerede"
            }
        ) {
